...
public class BookmarkPresenter implements Presenter<BookmarksFragment> {
  ...
  public void toggleGroupByTags() {
    ...
    requestData(false);
//    Answers.getInstance().logCustom(new CustomEvent(groupByTags ? "groupByTags" : "doNotGroupByTags")); //1L
  }
  ...
  public void toggleShowRecents() {
    ...
    requestData(false);
//    Answers.getInstance().logCustom(new CustomEvent(showRecents ? "showRecents" : "doNotMinimizeRecents")); //1L
  }
  ...
  public void toogleShowDate() {
    ...
    requestData(false);
//    Answers.getInstance().logCustom(new CustomEvent(showDate ? "showDate" : "doNotShowDate") //1L);
