...
import com.ermile.maalquran.android.presenter.audio.AudioPresenter;
import com.ermile.maalquran.android.presenter.bookmark.RecentPagePresenter;
...
import com.ermile.maalquran.android.ui.fragment.AyahActionFragment;
...
import com.ermile.maalquran.android.ui.helpers.QuranPageAdapter;
import com.ermile.maalquran.android.ui.helpers.SlidingPagerAdapter;
...
import com.ermile.maalquran.android.util.QuranAppUtils;
...
import com.ermile.maalquran.android.widgets.AudioStatusBar;
...
import com.ermile.maalquran.android.widgets.SlidingUpPanelLayout;
...
import static com.ermile.maalquran.android.ui.helpers.SlidingPagerAdapter.AUDIO_PAGE;
import static com.ermile.maalquran.android.ui.helpers.SlidingPagerAdapter.PAGES;
import static com.ermile.maalquran.android.ui.helpers.SlidingPagerAdapter.TAG_PAGE;
import static com.ermile.maalquran.android.ui.helpers.SlidingPagerAdapter.TRANSLATION_PAGE;
import static com.ermile.maalquran.android.widgets.AyahToolBar.AyahToolBarPosition;
  ...
  private void downloadRequiredFiles() {
    ...
    if (!quranFileUtils.haveAyaPositionFile(this)) {
      ...
      Intent intent = ServiceIntentHelper.getDownloadIntent(this, url,
          ...
          downloadType);
//      Crashlytics.log("starting service to download ayah position file"); //1L
      startService(intent);
...
//      Crashlytics.log("starting service to download arabic database"); //1L
      startService(intent);
    }
  ...
  public void handleRequiredDownload(Intent downloadIntent) {
    ...
    if (needsPermission) {
      ...
      audioStatusBar.switchMode(AudioStatusBar.DOWNLOADING_MODE);
//      Crashlytics.log("starting service in handleRequiredDownload"); //1L
...
//    Crashlytics.log("starting service for audio playback"); //1L
    startService(intent);
  }
